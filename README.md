...
1. When [publishing](https://github.com/uid100/Publish-AppService-to-Azure) to Azure for the first time, make sure to chose self-contained in the publishing settings.
