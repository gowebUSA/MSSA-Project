...
## Important codes:
1. [dotnet ef migrations add Initial] using cmd under the project folder on ASP page 214.
...
<br />The routing format is set in the Configure method in Startup.cs file but commented out on page 230.
