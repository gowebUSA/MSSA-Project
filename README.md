...
## Important codes:
1. [dotnet ef migrations add Initial] using cmd under the project folder.
<br />ASP page 214 and [ASP.NET Core 3.1 Tutorial](https://docs.microsoft.com/en-us/aspnet/core/tutorials/first-mvc-app/adding-model?view=aspnetcore-3.1&tabs=visual-studio#scaffold-movie-pages)
...
<br />The routing format is set in the Configure method in Startup.cs file.
